...
<body style="margin:0;">
  ...
  <div style="margin: 0; width: 98.5vw; height: 100vh; overflow: hidden; position: relative;">
    <div style="width: 100%; height: 42px; background: orange; text-align: center; padding-top: 10px; position: absolute;">
      <strong style="font-size: 20px;">SLR_portfolio</strong>
    </div>
    <img src="/SLR_portfolio/assets/images/radhakrishna.jpg"
    width="100%" height="100%"
     alt="Cover" layout="fixed-height" media="(min-width: 416px)">
    <div class="container" style="color: white; text-align: center; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
        <div style="font-size: 60px;">
          Portfolio
        </div>
        <div class="title-container" style="font-size: 50px;">
          신이룸의 포트폴리오입니다.
        </div>
    </div>
  </div>
...
<nav class="pagination" role="navigation">
  ...
  <div style="height:300px; background: white; padding-bottom: 30px; margin-bottom: 20px;">
    <table style="width: 100%; height: 300px;">
      <tr style="width: 800px; margin: 0;">
        <td style="display: inline-block; width: 30%; height: 100%; margin: 0; padding-top: 100px; text-align: center; vertical-align: middle;">
            <h1 style="text-decoration: underline;">About Me</h1>
        </td>
        <td style="display: inline-block; width: 50%;">
            <div style="height: 300px; text-align: left; padding-top: 20px; overflow: hidden;">
              <h2>멈추지 않는 개발자</h2>
  ...
  <div style="background: rgb(255, 229, 229); text-align: center; padding-bottom: 40px;">
    <h1 style="padding-top:20px; text-decoration: underline; margin-top: 0;">Project</h1><br>
...
<footer class="ampstart-footer flex flex-column items-center px3" style="text-align: center; margin-bottom: 40px;">

  
  <h1 style="padding-top:20px; text-decoration: underline; margin-top: 0;">Contact</h1>
  <div style="font-size: 24px;">

    <a href="https://dlfna1111.github.io/SLR_portfolio" style="text-decoration: none;">
      <strong>신이룸</strong></a><br>
    tdf5335@naver.com<br>
    010-5768-2494<br>
